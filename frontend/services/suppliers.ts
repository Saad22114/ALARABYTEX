...
export async function getSuppliersOverview(params?: Record<string, string | number | undefined | null>): Promise<SuppliersOverview> {
  const q = buildQuery(params || {});
  return apiRequest<SuppliersOverview>(`/suppliers/summary/${q}`);
}
